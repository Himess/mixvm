/**
 * Test Route 4: Ethereum Sepolia -> Arc Testnet
 *
 * Usage:
 *   npx hardhat run scripts/tests/test-route-4-ethereum-to-arc.ts --network ethereumSepolia
 */
...
async function main() {
    ...
    console.log("TEST ROUTE 4: Ethereum Sepolia -> Arc Testnet");
    console.log("=".repeat(60));
    ...
    console.log("Destination Domain:", CCTP_DOMAINS.arc, "(Arc Testnet)");
    ...
    console.log("\nNext: Call privateTransferCrossChain with domain=26 (Arc)");
    console.log("=".repeat(60));
}
